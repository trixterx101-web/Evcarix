...
class CreativeWriter:
    ...
    def generate_script(self, topic, format_type="short", category=None):
        ...
        if format_type == "short":
            ...
            user = f"""
Write a 60-second YouTube Shorts narration script for the "EV-care-icks" channel.
Topic: {topic}
Category: {category or 'general'}
...
- CTA (55-60s): Subscribe to "EV-care-icks" for real EV data, no hype

IMPORTANT INSTRUCTIONS:
1. Channel Name: ALWAYS start the script with "Welcome to EV-care-icks." and ALWAYS use "EV-care-icks" for the channel name. Do NOT use any other name or placeholder.
...
5. First sentence MUST be "Welcome to EV-care-icks." followed by a shocking stat.
...
"""
            ...
            user = f"""
Write a COMPLETE, FULL-LENGTH YouTube video narration script for the "EV-care-icks" channel.
Topic: {topic}
...
4. Structure: Write ALL 7 sections as continuous spoken narration:
   - Introduction (30s): Start with "Welcome to EV-care-icks." then the topic hook with a specific statistic.
   ...
   - Conclusion + CTA (20s): Summary + "Subscribe to EV-care-icks for real EV data."
...
"""
        ...
        if format_type == "long":
            ...
            return {
                "voice": "female",
                "script": (
                    f"Welcome to EV-care-icks, the channel where we replace manufacturer claims with real-world data. "
                    ...
                    f"subscribe to EV-care-icks. We publish detailed, data-driven EV analysis every week. "
        ...
        return {
            ...
            "script": (
                ...
                f"Subscribe to EV-care-icks for real EV data."
            )
        }
    ...
    def generate_description(self, topic, title, tags_list, cta_override=None, category=None, format_type="short"):
        ...
        credits = (
            "\n\n🎥 Footage & Sources:\n"
            "- Official Press/Newsroom clips (Tesla, BMW, Hyundai, etc.) for editorial use.\n"
            "- Research & Lab footage provided by NREL/DOE (Public Domain).\n"
            "- Creative Commons (CC BY) licensed assets from verified creators.\n"
            "- Visuals & Data analysis generated by Evcarix AI Engine.\n\n"
            "⚖️ Disclaimer: This video is for educational and informational purposes. "
            "All stock footage used is licensed under Creative Commons or provided by manufacturers for editorial coverage."
        )

        return f"{seo_body}{channel_about}{credits}\n\n{top_hashtags}"
